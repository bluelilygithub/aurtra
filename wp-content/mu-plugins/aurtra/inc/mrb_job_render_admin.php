...
function reorder_admin_jobs_callback() {
	...
	<div id="job-sort" class="wrap">
		...
		<h2><?php _e( 'Sort Job Positions: ', 'wp-job-listing-trans' ); ?><img src="<?php echo esc_url( admin_url() . '/images/loading.gif' ); ?>" id="loading-animation"></h2> 
...
add_action( 'wp_ajax_save_sort', 'mrb_save_reorder' );
