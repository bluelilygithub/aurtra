var portfolioPostsBtn = document.getElementById("faq_btn");
var portfolioPostsContainer = document.getElementById("faq_container");

if (portfolioPostsBtn) {
  portfolioPostsBtn.addEventListener("click", function() {

    var ourRequest = new XMLHttpRequest();
      ourRequest.open('GET', magicalData.siteURL + '/wp-json/wp/v2/faq_slug');
...
if (quickAddButton) {
  quickAddButton.addEventListener("click", function() {
    ...
    createPost.open("POST", magicalData.siteURL + "/wp-json/wp/v2/faq_slug");
